...
class ServiceNowController extends GetxController {
  ...
  void onInit() async {
    super.onInit();
    urlImgPublic.value = await _secureStorage.readSecureData('commonGetImgUrlPublic') ?? '';

    // await getAllItem(null, null, 1, 10);
    // await getAllBrand();
  ...
  Future<void> fetchBrands() async {
   ...
   Future<void> fetchItems() async {
    try {
      ...
      final itemResponse = await getAllItem(null, null, 1, 10);
  ...
  //       {
  //         'name': 'Brake Discs',
  //         'description': 'Durable brake discs',
  //         'price': 200.00,
  //         'rating': 4.7
  //       },
  //       {
  //         'name': 'Brake Fluid',
  //         'description': 'High-quality brake fluid',
  //         'price': 15.00,
  //         'rating': 4.6
  //       },
  //       {
  //         'name': 'Brake Calipers',
  //         'description': 'Performance brake calipers',
  //         'price': 300.00,
  //         'rating': 4.9
  //       },
  //       {
  //         'name': 'Brake Lines',
  //         'description': 'Stainless steel brake lines',
  //         'price': 50.00,
  //         'rating': 4.5
  //       },
  //     ],
  ...
  //       {
  //         'name': 'Fuel Pump',
  //         'description': 'High-performance fuel pump',
  //         'price': 150.00,
  //         'rating': 4.8
  //       },
  //       {
  //         'name': 'Timing Belt',
  //         'description': 'Durable timing belt',
  //         'price': 100.00,
  //         'rating': 4.7
  //       },
  //     ],
  ...
  //       {
  //         'name': 'Petronas F900',
  //         'description': 'Full Synthetic 5W-50',
  //         'price': 62.00,
  //         'rating': 4.7
  //       },
  //       {
  //         'name': 'Shell Advance',
  //         'description': 'Fully Synthetic 10W-40',
  //         'price': 70.00,
  //         'rating': 4.6
  //       },
  //       {
  ...
  //       {
  //         'name': 'Mobil 1',
  //         'description': 'Full Synthetic 0W-40',
  //         'price': 75.00,
  //         'rating': 4.9
  //       },
  //     ],
  ...
  //         'description': 'Cleans fuel system',
  //         'price': 15.00,
  //         'rating': 4.3
  //       },
  //       {
  //         'name': 'Octane Booster',
  //         'description': 'Increases fuel efficiency',
  //         'price': 20.00,
  //         'rating': 4.2
  //       },
  //       {
  //         'name': 'Engine Cleaner',
  //         'description': 'Cleans engine internals',
  //         'price': 18.00,
  //         'rating': 4.4
  //       },
  //       {
  ...
  //       {
  //         'name': 'Michelin Power',
  //         'description': '180/55-17 M/C',
  //         'price': 250.00,
  //         'rating': 4.9
  //       },
  //       {
  //         'name': 'Dunlop SportMax',
  //         'description': '190/50-17 M/C',
  //         'price': 240.00,
  //         'rating': 4.7
  //       },
  //       {
  ...
  //       {
  //         'name': 'LED Headlight',
  //         'description': 'Bright LED headlight kit',
  //         'price': 150.00,
  //         'rating': 4.6
  //       },
  //       {
  //         'name': 'Tail Light',
  //         'description': 'LED tail light upgrade',
  //         'price': 80.00,
  //         'rating': 4.5
  //       },
  //       {
  //         'name': 'Turn Signal Lights',
  //         'description': 'LED turn signal lights',
  //         'price': 40.00,
  //         'rating': 4.4
  //       },
  //       {
  //         'name': 'Fog Lights',
  //         'description': 'High-intensity fog lights',
  //         'price': 120.00,
  //         'rating': 4.7
  //       },
  //     ],
  ...
  //         'description': 'Tunable ECU upgrade',
  //         'price': 350.00,
  //         'rating': 4.7
  //       },
  //       {
  //         'name': 'Quick Shifter',
  //         'description': 'Smooth gear changes',
  //         'price': 200.00,
  //         'rating': 4.5
  //       },
  //       {
  ...
  //       {
  //         'name': 'Air Intake',
  //         'description': 'High-flow air intake',
  //         'price': 300.00,
  //         'rating': 4.6
  //       },
  //     ],
...
// }
  ...
  //   if (categories.isEmpty) return [];
  //   final categoryId = categories[selectedCategoryIndex.value]['id'] as String;

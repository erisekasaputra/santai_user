            ...
            children: [
              AspectRatio(
                ...
                child: Container(
                  ...
                  child: controller.selectedMotorcycle.value?.imageUrl != null
                      ? Image.network(
                          '${controller.urlImgPublic}${controller.selectedMotorcycle.value?.imageUrl}',
                          fit: BoxFit.cover,
                        )
                      : const Center(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 5),
                        Text(
                          controller.selectedMotorcycle.value?.brand ?? '',
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                _buildDetailRow('Model', controller.selectedMotorcycle.value?.brand ?? ''),
                _buildDetailRow('Engine Capacity', controller.selectedMotorcycle.value?.brand ?? ''),
                _buildDetailRow('Engine Number', controller.selectedMotorcycle.value?.engineNumber ?? ''),
                _buildDetailRow('Chassis Number', controller.selectedMotorcycle.value?.chassisNumber ?? ''),
                _buildDetailRow('Insurer', controller.selectedMotorcycle.value?.brand ?? ''),
                _buildDetailRow('Insurance Expire', controller.selectedMotorcycle.value?.brand ?? ''),
                _buildDetailRow('Roadtax Expire', controller.selectedMotorcycle.value?.brand ?? ''),
                _buildDetailRow('Previous Service', controller.selectedMotorcycle.value?.brand ?? ''),
                _buildDetailRow('ODO Meter', '${controller.selectedMotorcycle.value?.brand ?? ''} km'),
              ],
            ),
          ),
        ],

...
//               children: [
//                 const Text('Order ID #00024', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
...
//     runSpacing: 8,
//     children: [
//         Obx(() => _buildScheduleItem(Icons.calendar_today, controller.selectedDate.value, _selectDate)),
//         Obx(() => _buildScheduleItem(Icons.access_time, controller.selectedTime.value, _selectTime)),
...
//             children: [
//               Text('Items', style: TextStyle(fontWeight: FontWeight.bold, color: text_01)),
//               Text('Price', style: TextStyle(fontWeight: FontWeight.bold, color: text_01)),
//             ],
//           ),
//         ),

...
class OrderCalculationResponseModel extends OrderCalculationResponse {
  OrderCalculationResponseModel({
    required bool isSuccess,
    required OrderCalculationResponseDataModel data,
  ...
  factory OrderCalculationResponseModel.fromJson(Map<String, dynamic> json) {
    return OrderCalculationResponseModel(
      isSuccess: json['isSuccess'],
      data: OrderCalculationResponseDataModel.fromJson(json['data']),
...
class OrderCalculationResponseDataModel extends OrderCalculationResponseData {
  OrderCalculationResponseDataModel({
  ...
  factory OrderCalculationResponseDataModel.fromJson(
      Map<String, dynamic> json) {
    return OrderCalculationResponseDataModel(

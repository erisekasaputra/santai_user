...
import '../../models/authentikasi/auth_sign-in_req_model.dart';
...
import 'package:santai/app/data/models/authentikasi/auth_sign-in_staff_req_model.dart';
...
class AuthRepositoryImpl implements AuthRepository {
  ...
  @override
  Future<OtpRegisterVerifyResponse> otpRegisterVerify(OtpRegisterVerify request) async {
    final otpRegisterVerifyModel = OtpRegisterVerifyModel.fromEntity(request);
    final response = await remoteDataSource.otpRegisterVerify(otpRegisterVerifyModel);
    return response;
  }
